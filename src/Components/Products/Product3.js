...
function Product2() {
  ...
  useEffect(() => {
    const result = axios
      .get("https://shopnewage.com/collections/home-bar/products/home-bar-3-drawer-cabinet-21-61003.json")
          ...
          <div className="card" style={{ width: "25rem",padding:'10px',height:"30rem" }}>
            ...
            <div>
              <a
                ...
                onClick={() =>
                  window.open("https://shopnewage.com/collections/home-bar/products/home-bar-3-drawer-cabinet-21-61003")
                }
              >
                BUY NOW
              </a>
